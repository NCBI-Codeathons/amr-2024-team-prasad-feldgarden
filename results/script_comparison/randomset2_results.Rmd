...
- `DGW.py` identified 1074 records that `scanner.R` did not identify.
  - 245 (22.8%) of those records was also present in Microbigg-E but reporting a different lesion
...
- There were 624 records were a mutation was found for the same gene, but the lesions reported by the DGW scripts are different from the lesions reported in Microbigg-E
